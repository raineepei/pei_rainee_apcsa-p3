			  ...
			  for (int col = 0; col < this.getWidth(); col++)
			  {
				  ...
				  if (messagePixel.colorDistance(Color.BLACK) < 50)
				  {
					  ...
					  while (!isPrime(currentPixel.getBlue()))
					  {
						  ...
						  currentPixel.setBlue(currentPixel.getBlue() - 1);
						  else currentPixel.setBlue(1);
						  System.out.println(currentPixel.getBlue()+ "blah");
					  }
					  
					  }
					  if (isPrime(currentPixel.getGreen()))
					  {
						  System.out.println("\n on entry " + currentPixel.getBlue());
					  while (isPrime(currentPixel.getBlue()))
					  {
						  if (currentPixel.getBlue() > 0)
						  currentPixel.setBlue(currentPixel.getBlue() - 1); 
						  else currentPixel.setBlue(4);
						  System.out.println(currentPixel.getBlue());
					  }
